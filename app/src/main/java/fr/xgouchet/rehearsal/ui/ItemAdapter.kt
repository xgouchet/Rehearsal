...
class ItemAdapter(private val listener: ItemListener)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Item.ViewHolder<*> {
        ...
        return when (viewType) {
            ...
            Item.Type.REHEARSAL.ordinal -> ItemRehearsal.instantiateViewHolder(inflater, parent, listener)
            Item.Type.RANGE.ordinal -> ItemRange.instantiateViewHolder(inflater, parent, listener)
            Item.Type.PROP.ordinal -> ItemProp.instantiateViewHolder(inflater, parent, listener)
            ...
            Item.Type.INTERACTIVE.ordinal -> ItemInteractive.instantiateViewHolder(inflater, parent, listener)
