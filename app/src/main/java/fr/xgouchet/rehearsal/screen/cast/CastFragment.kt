...
class CastFragment
    ...
    private var colorPickerRequest: Long = 0
    ...
    override fun showColorPicker(requestId: Long, @ColorInt color: Int) {
    ...
    override fun showEnginePicker(requestId: Long, engine: String?) {
    ...
    private fun showEngineDialog(requestId: Long,
                                 context: Context,
