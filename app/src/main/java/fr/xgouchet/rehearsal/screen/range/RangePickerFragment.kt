...
class RangePickerFragment
    ...
    override fun showScenePicker(scenes: List<Pair<Long, String>>) {
    ...
    override fun showCuePicker(requestId: Int, cues: List<Pair<Long, String>>) {
        val currentActivity = activity ?: return
    ...
    override fun navigateBackWithResult(range: Range) {
        val currentActivity = activity ?: return

        val data = Intent()
        data.putExtra(RangePickerActivity.EXTRA_RANGE, range)
